...
<main>
    ...
    <div class="conteneur-modification-pilote">
        <h1 class="modification-pilote">Suppression d'un compte pilote</h1>

        <form action="<?= ADRESSE_SITE ?>/pilote/supprimer/<?= $pilote->id ?>" method="post">
            <fieldset class="rectangle-gris">
                <div class="ligne">
                    ...
                    <div class="classe-pilote">
                        ...
                        <input class="case-standard case-classe-pilote" type="text" name="classe-pilote" id="classe-pilote" disabled><br><br>
                    </div>
                </div> -->
                </div>
