...
<main class="main-lecture" id="main-supprimer-etudiant">
    ...
    <div class="conteneur-modification-etudiant">
        <h1 class="modification-etudiant">Supprimer un compte étudiant</h1>
        <form action="<?= ADRESSE_SITE ?>/etudiant/supprimer/<?= $etudiant->id ?>" method="post">
...
$metaDescription = "Page de suppression d'étudiants du site StagEureka";
