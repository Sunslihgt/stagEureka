    ...
    <div class="conteneur-creation-etudiant">
        ...
        <form action="<?= ADRESSE_SITE ?>/candidature/supprimer/<?= $candidature->idCandidature ?>" method="post">
            <div class="conteneur-bouton-principal">
                <input class="bouton-principal" type="submit" value="Supprimer la candidature">
            </div>
...
$titreOnglet = "Supression d'une candidature à un stage StagEureka - Trouvez votre stage";
$metaDescription = "Page de supression d'une candidature d'un stage du site StagEureka";
